  ...
  >
    ...
    >
      <span
        ...
        class="vl-slider-line-one"
      />
      <span class="vl-slider-line-two" />

      <span
        :class="{'run-effect':effect}"
        :style="styleEfect"
        class="vl-slider-line-efect"
      />
    ...
    <button
      ...
      :style="styleCircle"
      class="vl-circle-slider vl-circles-slider vl-slider--circles vl-slider--circle"
      @touchstart="activeFocus($event),actived = true"
      @mousedown="activeFocus($event),actived = true"
    >
      <span
        :style="styleText"
        class="text-circle-slider vl-slider--circle-text"
      >
        {{ valueCircle1 }}
        <span v-if="textFixed">
          {{ textFixed }}
    ...
    <button
      ...
      class="vl-circle-slider-two vl-circles-slider vl-slider--circles vl-slider--circle-two"
