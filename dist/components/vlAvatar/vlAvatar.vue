<template lang="html">
  ...
  >
    <div
      ...
      :style="badgeStyle"
      :class="badgeClass"
      class="dot-count vl-avatar--count"
    >
      {{ typeof badge != 'boolean' ? badge : null }}
    </div>
    <div
      v-if="src"
      class="con-img vl-avatar--con-img"
    >
      <img
        :src="src"
        alt=""
    ...
    <span
      ...
      translate="no"
      class="vl-avatar--text notranslate"
    >
  ...
  computed:{
    avatarClass() {
      ...
      if (_color.isColor(this.color)) {
        classes[`con-vl-avatar-${this.color}`] = true
      }
      return classes
    },
    avatarStyle() {
    ...
    textClass() {
      ...
      if (_color.isColor(this.textColor)) {
        classes[`vl-avatar-text-${this.textColor}`] = true
      }
      return classes
    },
    textStyle() {
