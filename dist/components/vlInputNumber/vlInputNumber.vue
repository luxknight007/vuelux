<template lang="html">
  <div
    :class="[
      `vl-input-number-size-${size}`,
      `vl-input-number-${color}`,
      {'isChangeValue':isChangeValue}
    ]"
    class="vl-input-number"
  >
    <button
      v-repeat-click="less"
      ...
      class="btn-less vl-input-number--button-less"
      type="button"
    >
      <VlIcon
        :icon-pack="iconPack"
    ...
    <button
      ...
      class="btn-plus vl-input-number--button-plus"
      type="button"
    >
      <VlIcon
        :icon-pack="iconPack"
